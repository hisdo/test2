...
pkgdatadir = $(datadir)/shark
pkgincludedir = $(includedir)/shark
pkglibdir = $(libdir)/shark
pkglibexecdir = $(libexecdir)/shark
...
DIST_COMMON = $(srcdir)/Makefile.am $(srcdir)/Makefile.in \
	$(srcdir)/Makefile.include $(srcdir)/bitcoin-config.h.in
am__append_1 =  \
...
am__append_5 = sharkd
am__append_6 = shark-cli
#am__append_7 = compat/glibc_compat.cpp \
#	compat/glibcxx_compat.cpp
am__append_8 = libbitcoin_wallet.a
#
am__append_9 = bitcoind-res.rc
#
am__append_10 = bitcoin-cli-res.rc
subdir = src
...
am__objects_1 =
am_libbitcoin_cli_a_OBJECTS = rpcclient.$(OBJEXT) $(am__objects_1)
libbitcoin_cli_a_OBJECTS = $(am_libbitcoin_cli_a_OBJECTS)
libbitcoin_common_a_AR = $(AR) $(ARFLAGS)
libbitcoin_common_a_LIBADD =
am__libbitcoin_common_a_SOURCES_DIST = base58.cpp allocators.cpp \
	chainparams.cpp core.cpp hash.cpp blake.c bmw.c groestl.c jh.c \
	keccak.c skein.c key.cpp netbase.cpp protocol.cpp \
	rpcprotocol.cpp script.cpp sync.cpp util.cpp version.cpp \
	addrman.h alert.h allocators.h base58.h bignum.h bloom.h \
	chainparams.h checkpoints.h checkqueue.h clientversion.h \
	coincontrol.h coins.h compat.h core.h crypter.h db.h hash.h \
	hashblock.h sph_types.h sph_blake.h sph_bmw.h sph_groestl.h \
	sph_jh.h sph_keccak.h sph_skein.h init.h key.h keystore.h \
	leveldbwrapper.h limitedmap.h main.h miner.h mruset.h \
	netbase.h net.h noui.h protocol.h rpcclient.h rpcprotocol.h \
	rpcserver.h script.h serialize.h sync.h threadsafety.h \
...
am_libbitcoin_common_a_OBJECTS = base58.$(OBJEXT) allocators.$(OBJEXT) \
	chainparams.$(OBJEXT) core.$(OBJEXT) hash.$(OBJEXT) \
	blake.$(OBJEXT) bmw.$(OBJEXT) groestl.$(OBJEXT) jh.$(OBJEXT) \
	keccak.$(OBJEXT) skein.$(OBJEXT) key.$(OBJEXT) \
...
nodist_libbitcoin_common_a_OBJECTS =
libbitcoin_common_a_OBJECTS = $(am_libbitcoin_common_a_OBJECTS) \
	$(nodist_libbitcoin_common_a_OBJECTS)
libbitcoin_server_a_AR = $(AR) $(ARFLAGS)
libbitcoin_server_a_LIBADD =
am_libbitcoin_server_a_OBJECTS = addrman.$(OBJEXT) alert.$(OBJEXT) \
	bloom.$(OBJEXT) checkpoints.$(OBJEXT) coins.$(OBJEXT) \
	init.$(OBJEXT) keystore.$(OBJEXT) leveldbwrapper.$(OBJEXT) \
	main.$(OBJEXT) miner.$(OBJEXT) net.$(OBJEXT) noui.$(OBJEXT) \
	rpcblockchain.$(OBJEXT) rpcmining.$(OBJEXT) rpcmisc.$(OBJEXT) \
	rpcnet.$(OBJEXT) rpcrawtransaction.$(OBJEXT) \
	rpcserver.$(OBJEXT) txdb.$(OBJEXT) txmempool.$(OBJEXT) \
...
am_libbitcoin_wallet_a_OBJECTS = db.$(OBJEXT) crypter.$(OBJEXT) \
...
am__EXEEXT_1 = sharkd$(EXEEXT)
am__EXEEXT_2 = shark-cli$(EXEEXT)
am__installdirs = "$(DESTDIR)$(bindir)"
PROGRAMS = $(bin_PROGRAMS)
am__shark_cli_SOURCES_DIST = bitcoin-cli.cpp bitcoin-cli-res.rc
am__objects_3 = bitcoin-cli-res.$(OBJEXT)
am_shark_cli_OBJECTS = bitcoin-cli.$(OBJEXT) $(am__objects_3)
shark_cli_OBJECTS = $(am_shark_cli_OBJECTS)
am__DEPENDENCIES_1 =
shark_cli_DEPENDENCIES = libbitcoin_cli.a libbitcoin_common.a \
	$(am__DEPENDENCIES_1)
am__sharkd_SOURCES_DIST = bitcoind.cpp bitcoind-res.rc
am__objects_4 = bitcoind-res.$(OBJEXT)
am_sharkd_OBJECTS = bitcoind.$(OBJEXT) $(am__objects_4)
sharkd_OBJECTS = $(am_sharkd_OBJECTS)
am__DEPENDENCIES_2 = $(am__append_2)
am__DEPENDENCIES_3 = $(am__append_3)
sharkd_DEPENDENCIES = libbitcoin_server.a libbitcoin_cli.a \
	libbitcoin_common.a $(am__DEPENDENCIES_2) \
	$(am__DEPENDENCIES_3) $(am__append_8) $(am__DEPENDENCIES_1) \
	$(am__DEPENDENCIES_1)
DEFAULT_INCLUDES = -I.
...
SOURCES = $(libbitcoin_cli_a_SOURCES) $(libbitcoin_common_a_SOURCES) \
	$(nodist_libbitcoin_common_a_SOURCES) \
	$(libbitcoin_server_a_SOURCES) $(libbitcoin_wallet_a_SOURCES) \
	$(shark_cli_SOURCES) $(sharkd_SOURCES)
DIST_SOURCES = $(libbitcoin_cli_a_SOURCES) \
	$(am__libbitcoin_common_a_SOURCES_DIST) \
	$(libbitcoin_server_a_SOURCES) $(libbitcoin_wallet_a_SOURCES) \
	$(am__shark_cli_SOURCES_DIST) $(am__sharkd_SOURCES_DIST)
...
am__relativize = \
  ...
  reldir="$$dir2"
ACLOCAL = ${SHELL} /c/s3a/src/build-aux/missing --run aclocal-1.11
AMTAR = ${SHELL} /c/s3a/src/build-aux/missing --run tar
AM_DEFAULT_VERBOSITY = 0
AR = /c/mingw32/bin/ar
AUTOCONF = ${SHELL} /c/s3a/src/build-aux/missing --run autoconf
AUTOHEADER = ${SHELL} /c/s3a/src/build-aux/missing --run autoheader
AUTOMAKE = ${SHELL} /c/s3a/src/build-aux/missing --run automake-1.11
AWK = gawk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BOOST_CHRONO_LIB = -lboost_chrono-mgw49-mt-s-1_57 
BOOST_CPPFLAGS = -mthreads -I/c/deps/boost_1_57_0
BOOST_FILESYSTEM_LIB = -lboost_filesystem-mgw49-mt-s-1_57
BOOST_LDFLAGS = -L/c/deps/boost_1_57_0/stage/lib
BOOST_LIBS = -L/c/deps/boost_1_57_0/stage/lib -lboost_system-mgw49-mt-s-1_57 -lboost_filesystem-mgw49-mt-s-1_57 -lboost_program_options-mgw49-mt-s-1_57 -lboost_thread-mgw49-mt-s-1_57 -lboost_chrono-mgw49-mt-s-1_57 
BOOST_PROGRAM_OPTIONS_LIB = -lboost_program_options-mgw49-mt-s-1_57
BOOST_SYSTEM_LIB = -lboost_system-mgw49-mt-s-1_57
BOOST_THREAD_LIB = -lboost_thread-mgw49-mt-s-1_57
...
COPYRIGHT_YEAR = 2014
CPP = gcc -E
CPPFLAGS = -I/c/deps/db-4.8.30.NC/build_unix -I/c/deps/openssl-1.0.1j/include -I/c/deps -I/c/deps/protobuf-2.6.1/src -I/c/deps/libpng-1.6.15 -I/c/deps/qrencode-3.4.4 -DBOOST_SPIRIT_THREADSAFE -DHAVE_BUILD_INFO -D__STDC_FORMAT_MACROS -D_MT -DWIN32 -D_WINDOWS -DBOOST_THREAD_USE_LIB -D_FILE_OFFSET_BITS=64  -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -DSTATICLIB
CRYPTO_CFLAGS = 
CRYPTO_LIBS = 
CXX = g++
CXXCPP = g++ -E
...
LCOV = 
LDFLAGS = -L/c/deps/db-4.8.30.NC/build_unix -L/c/deps/openssl-1.0.1j -L/c/deps/miniupnpc -L/c/deps/protobuf-2.6.1/src/.libs -L/c/deps/libpng-1.6.15/.libs -L/c/deps/qrencode-3.4.4/.libs -static -static-libgcc -static-libstdc++ -Wl,--large-address-aware  -Wl,--dynamicbase -Wl,--nxcompat
...
LN_S = cp -p
LRELEASE = /c/Qt/5.3.2/bin/lrelease
LTLIBOBJS = 
LUPDATE = /c/Qt/5.3.2/bin/lupdate
MAINT = 
MAKEINFO = ${SHELL} /c/s3a/src/build-aux/missing --run makeinfo
MAKENSIS = none
MKDIR_P = /bin/mkdir -p
MOC = /c/Qt/5.3.2/bin/moc
...
OTOOL = 
PACKAGE = shark
PACKAGE_BUGREPORT = info@shark.cc
PACKAGE_NAME = Shark Core
PACKAGE_STRING = Shark Core 0.9.2
PACKAGE_TARNAME = shark
PACKAGE_URL = 
...
PROTOBUF_CFLAGS = 
PROTOBUF_LIBS = 
PROTOC = /c/deps/protobuf-2.6.1/src/protoc
PTHREAD_CC = gcc
PTHREAD_CFLAGS = 
PTHREAD_LIBS = 
QR_CFLAGS = 
...
QT_DBUS_CFLAGS = 
QT_DBUS_INCLUDES = 
QT_DBUS_LIBS = -L/c/Qt/5.3.2/lib
QT_INCLUDES = -I/c/Qt/5.3.2/include -I/c/Qt/5.3.2/include/QtCore -I/c/Qt/5.3.2/include/QtGui -I/c/Qt/5.3.2/include/QtWidgets -I/c/Qt/5.3.2/include/QtNetwork -I/c/Qt/5.3.2/include/QtTest -I/c/Qt/5.3.2/include/QtDBus
QT_LDFLAGS =  -mwindows
QT_LIBS = -lqwindows -lqtaccessiblewidgets -lQt5Widgets -lQt5Network -lQt5Gui     -lQt5Core    -lpng  -lz  -limm32  -L/c/Qt/5.3.2/lib -L/c/Qt/5.3.2/plugins/accessible -L/c/Qt/5.3.2/plugins/platforms
QT_SELECT = qt5
QT_TEST_CFLAGS = 
QT_TEST_INCLUDES = 
QT_TEST_LIBS = -lQt5Test -L/c/Qt/5.3.2/lib
RANLIB = /c/mingw32/bin/ranlib
RCC = /c/Qt/5.3.2/bin/rcc
SED = /bin/sed
SET_MAKE = 
SHELL = /bin/sh
SSL_CFLAGS = 
...
XGETTEXT = 
abs_builddir = /c/s3a/src
abs_srcdir = /c/s3a/src
abs_top_builddir = /c/s3a
abs_top_srcdir = /c/s3a
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_OBJC = gcc
ac_ct_OBJCXX = g++
...
install_sh = ${SHELL} /c/s3a/src/build-aux/install-sh
...
libbitcoin_common_a_SOURCES = base58.cpp allocators.cpp \
	chainparams.cpp core.cpp hash.cpp blake.c bmw.c groestl.c jh.c \
	keccak.c skein.c key.cpp netbase.cpp protocol.cpp \
	rpcprotocol.cpp script.cpp sync.cpp util.cpp version.cpp \
	$(BITCOIN_CORE_H) $(am__append_7)
...
# sharkd binary #
sharkd_LDADD = libbitcoin_server.a libbitcoin_cli.a \
	libbitcoin_common.a $(LIBLEVELDB) $(LIBMEMENV) $(am__append_8) \
	$(BOOST_LIBS) $(BDB_LIBS)
sharkd_SOURCES = bitcoind.cpp $(am__append_9)
...
shark_cli_SOURCES = bitcoin-cli.cpp $(am__append_10)
...
libbitcoin_cli.a: $(libbitcoin_cli_a_OBJECTS) $(libbitcoin_cli_a_DEPENDENCIES) 
...
compat/glibcxx_compat.$(OBJEXT): compat/$(am__dirstamp) \
	compat/$(DEPDIR)/$(am__dirstamp)
libbitcoin_common.a: $(libbitcoin_common_a_OBJECTS) $(libbitcoin_common_a_DEPENDENCIES) 
...
libbitcoin_server.a: $(libbitcoin_server_a_OBJECTS) $(libbitcoin_server_a_DEPENDENCIES) 
...
libbitcoin_wallet.a: $(libbitcoin_wallet_a_OBJECTS) $(libbitcoin_wallet_a_DEPENDENCIES) 
...
shark-cli$(EXEEXT): $(shark_cli_OBJECTS) $(shark_cli_DEPENDENCIES) 
	@rm -f shark-cli$(EXEEXT)
	$(AM_V_CXXLD)$(CXXLINK) $(shark_cli_OBJECTS) $(shark_cli_LDADD) $(LIBS)
sharkd$(EXEEXT): $(sharkd_OBJECTS) $(sharkd_DEPENDENCIES) 
	@rm -f sharkd$(EXEEXT)
	$(AM_V_CXXLD)$(CXXLINK) $(sharkd_OBJECTS) $(sharkd_LDADD) $(LIBS)

mostlyclean-compile:
	-rm -f *.$(OBJEXT)
	-rm -f compat/glibc_compat.$(OBJEXT)
	-rm -f compat/glibcxx_compat.$(OBJEXT)
...
include ./$(DEPDIR)/bitcoin-cli.Po
include ./$(DEPDIR)/bitcoind.Po
...
TAGS: tags-recursive $(HEADERS) $(SOURCES) bitcoin-config.h.in $(TAGS_DEPENDENCIES) \
		$(TAGS_FILES) $(LISP)
	set x; \
	here=`pwd`; \
	...
	list='$(SOURCES) $(HEADERS) bitcoin-config.h.in $(LISP) $(TAGS_FILES)'; \
	unique=`for i in $$list; do \
	    if test -f "$$i"; then echo $$i; else echo $(srcdir)/$$i; fi; \
	  done | \
	  $(AWK) '{ files[$$0] = 1; nonempty = 1; } \
...
ctags: CTAGS
CTAGS: ctags-recursive $(HEADERS) $(SOURCES) bitcoin-config.h.in $(TAGS_DEPENDENCIES) \
		$(TAGS_FILES) $(LISP)
	list='$(SOURCES) $(HEADERS) bitcoin-config.h.in $(LISP) $(TAGS_FILES)'; \
	unique=`for i in $$list; do \
	    if test -f "$$i"; then echo $$i; else echo $(srcdir)/$$i; fi; \
...
all-am: Makefile $(LIBRARIES) $(PROGRAMS) bitcoin-config.h
